...
class TimeDelta:
    ...
    def __init__(self, past_date, current_date):  # past_date - прошлая дата / current_date - нынешняя(будущая)
...
class AiohttpSession:
    def __init__(self, limit=25, ssl=True, total=320, sock_connect=320, sock_read=320, trust_env=True, logger=None):
        """
